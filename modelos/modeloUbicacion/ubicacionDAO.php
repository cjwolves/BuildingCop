...
class UbicacionDAO extends ConBdMySql{
    ...
    public function insertar($registro){
        ...
        try {
            ...
            $consulta="INSERT INTO ubicacion (ubiId, usuLogin, usuPassword, usuEstado) VALUES (:ubiId, :usuLogin, :usuPassword, :usuEstado);" ;

            $insertar=$this->conexion->prepare($consulta);

            $insertar -> bindParam(":ubiId", $registro['ubiId']);
